...
export default class CreateTables1626124584126 implements MigrationInterface {
  name = 'CreateTables1626124584126';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "student" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "key" integer NOT NULL, "created_At" TIMESTAMP NOT NULL DEFAULT now(), "updated_At" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_3d8016e1cb58429474a3c041904" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "student_disciplines_discipline" ("studentId" uuid NOT NULL, "disciplineId" uuid NOT NULL, CONSTRAINT "PK_636b7288f665b0f25f393260d73" PRIMARY KEY ("studentId", "disciplineId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_e79d445cbf31beca9e94e61f77" ON "student_disciplines_discipline" ("studentId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_6c73cbc1fea7db56ae6dcc9151" ON "student_disciplines_discipline" ("disciplineId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "student_disciplines_discipline" ADD CONSTRAINT "FK_e79d445cbf31beca9e94e61f770" FOREIGN KEY ("studentId") REFERENCES "student"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "student_disciplines_discipline" ADD CONSTRAINT "FK_6c73cbc1fea7db56ae6dcc91518" FOREIGN KEY ("disciplineId") REFERENCES "discipline"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "student_disciplines_discipline" DROP CONSTRAINT "FK_6c73cbc1fea7db56ae6dcc91518"`,
    );
    await queryRunner.query(
      `ALTER TABLE "student_disciplines_discipline" DROP CONSTRAINT "FK_e79d445cbf31beca9e94e61f770"`,
    );
    await queryRunner.query(
